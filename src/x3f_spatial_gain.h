...
extern int x3f_get_merrill_type_spatial_gain(x3f_t *x3f, int hp_flag, x3f_spatial_gain_corr_t *corr);
extern int x3f_get_interp_merrill_type_spatial_gain(x3f_t *x3f, int hp_flag,
                                                    x3f_spatial_gain_corr_t *corr);
extern int x3f_get_classic_spatial_gain(x3f_t *x3f, char *wb, x3f_spatial_gain_corr_t *corr);
extern int x3f_get_spatial_gain(x3f_t *x3f, char *wb, x3f_spatial_gain_corr_t *corr);
extern void x3f_cleanup_spatial_gain(x3f_spatial_gain_corr_t *corr, int corr_num);
